...
- (void)resizeForTitle {
    float width = [self.titleLabel.text widthForHeight:self.titleLabel.bounds.size.height font:self.titleLabel.font];
    // [self.titleLabel.text sizeWithFont:self.titleLabel.font constrainedToSize:CGSizeMake(300, self.bounds.size.height)].width+10;
